    ...
    <ul class="nav navbar-nav">
      ...
      <li class="dropdown">
        ...
        <ul class="dropdown-menu">
          ...
          <li><a class="btn btn-primary" href='Sort1?coll1=Pernia Pop Up Shop&username=${username}'>Pernias Pop up Shop</a></li>
        </ul>
      </li>
    </ul>
...
<div class="alert alert-success">
  <strong> Welcome ${username}!</strong>  Happy Shopping
</div>
...
<thead>
	...
	<c:forEach items="${clothList}" var="m">
		<tr>
		...
		<td>
			...
			<td>
				<a class="btn btn-primary" href='Product?clothes_id=${m.clothes_id}&username=${username}'> Details</a>
			</td>
		</tr>
	</c:forEach>
</table>
