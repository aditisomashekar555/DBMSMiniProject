    ...
    <ul class="nav navbar-nav">
      ...
      <li class="dropdown">
        ...
        <ul class="dropdown-menu">
          <li><a class="btn btn-primary" href="lr.jsp">Winter</a></li>
          <li><a class="btn btn-primary" href="lr.jsp">Summer</a></li>
          <li><a class="btn btn-primary" href="lr.jsp">Rainy</a></li>
          <li><a class="btn btn-primary" href="lr.jsp">Spring</a></li>
          <li><a class="btn btn-primary" href="lr.jsp">Fall</a></li>
        </ul>
      </li>
      <li class="dropdown">
        ...
        <span class="caret"></span></a>
        <ul class="dropdown-menu">
          <li><a class="btn btn-primary" href="lr.jsp">Adidas</a></li>
          <li><a class="btn btn-primary" href="lr.jsp">Shein</a></li>
          <li><a class="btn btn-primary" href="lr.jsp">Lulu and Sky</a></li>
          <li><a class="btn btn-primary" href="lr.jsp">Pernias Pop up Shop</a></li> </ul>
  </li>
        </ul>
      </li>
    </ul>
